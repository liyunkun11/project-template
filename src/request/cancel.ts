...
// 是否需要取消请求
export const isNeedCancel = (url: string) => {
  return !notCancel.includes(url);
};

// 获取请求体
export const getRequestBody = (config: AxiosRequestConfig) => {
...
// 取消请求
export const cancelRequest = (config: AxiosRequestConfig, requestArr: any[]) => {
